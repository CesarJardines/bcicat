...
def RePreguntaInicial(request):

	return render(request, "estudiante/RePreguntaInicial.html")

def AnexoProducto(request):

	return render(request, "estudiante/AnexoProducto.html")

def RePreguntasSecundarias(request):

	return render(request, "estudiante/RePreguntasSecundarias.html")

def CuestionarioEvaluacion(request):
	return render(request, "estudiante/CuestionarioEvaluacion.html")